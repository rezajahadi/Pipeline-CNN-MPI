...
int main(int argc, char *argv[])
{
    ...
    case 1:
        ...
        linputf = fopen("linputf.txt", "w");
        if (linputf == NULL)
        {
            printf("Error opening linputf.txt for writing.\n");
            return 1;
        }

        lconv1f = fopen("lconv1f.txt", "w");
        if (lconv1f == NULL)
        {
            printf("Error opening lconv1f.txt for writing.\n");
            return 1;
        }

        lconv2f = fopen("lconv2f.txt", "w");
        if (lconv2f == NULL)
        {
            printf("Error opening lconv2f.txt for writing.\n");
            return 1;
        }

        lfull1f = fopen("lfull1f.txt", "w");
        if (lfull1f == NULL)
        {
            printf("Error opening lfull1f.txt for writing.\n");
            return 1;
        }

        lfull2f = fopen("lfull2f.txt", "w");
        if (lfull2f == NULL)
        {
            printf("Error opening lfull2f.txt for writing.\n");
            return 1;
        }

        loutputf = fopen("loutputf.txt", "w");
        if (loutputf == NULL)
        {
            printf("Error opening loutputf.txt for writing.\n");
            return 1;
        }
